...
const PokemonForm: FunctionComponent<Props> = ({ pokemon, isEditForm }) => {
    ...
    const selectType = (type: string, e: React.ChangeEvent<HTMLInputElement>): void => {
        ...
        if (checked) {
            // Si l'utilisateur décoche un type, à l'ajout à la liste des types de pokémon.
    ...
    const validateForm = () => {
        ...
        if (!/^[0-9]{1,2}$/.test(form.cp.value)) {
            const errorMsg: string = `Les points de vie du pokémon sont compris entre 0 et 99.`
